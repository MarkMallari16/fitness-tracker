      ...
      <div className='mt-20 w-full'>
        <div>
          <div className='flex justify-center items-center gap-1 text-center'>
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-dumbbell-icon lucide-dumbbell text-primary size-10"><path d="M17.596 12.768a2 2 0 1 0 2.829-2.829l-1.768-1.767a2 2 0 0 0 2.828-2.829l-2.828-2.828a2 2 0 0 0-2.829 2.828l-1.767-1.768a2 2 0 1 0-2.829 2.829z" /><path d="m2.5 21.5 1.4-1.4" /><path d="m20.1 3.9 1.4-1.4" /><path d="M5.343 21.485a2 2 0 1 0 2.829-2.828l1.767 1.768a2 2 0 1 0 2.829-2.829l-6.364-6.364a2 2 0 1 0-2.829 2.829l1.768 1.767a2 2 0 0 0-2.828 2.829z" /><path d="m9.6 14.4 4.8-4.8" /></svg>
        ...
        <div className='mt-6'>
          <button className='btn btn-primary cursor-pointer flex justify-center  items-center gap-1  text-white p-2 rounded-md w-full lg:w-48 font-medium '>
            ...
            <div key={workout._id} className='bg-white mb-4 px-8 py-6 rounded-md'>
              <div className='flex justify-between'>
                ...
                <div className='flex items-center gap-2'>
                  ...
                  <button className='p-2 hover:bg-gray-200 transition-all ease-in-out text-red-500  rounded-md cursor-pointer' onClick={() => deleteWorkout(workout._id)}>
              ...
              <div className='flex justify-between items-center pt-4 '>
                <div className='flex gap-6 text-center'>
                  ...
                  <div>
                    <h3 className='text-2xl text-purple-500 font-bold'>48</h3>
